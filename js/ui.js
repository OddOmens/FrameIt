...
window.UI = {
    ...
    renderGallery(canvases, selectedId) {
        if (window.GalleryManager) {
            window.GalleryManager.render(canvases, selectedId);
        } else {
            console.error('GalleryManager not found');
        }
    },

    // Create thumbnail for canvas without image - delegated to GalleryManager
    createCanvasThumbnail(canvas) {
        if (window.GalleryManager) {
            return window.GalleryManager.createCanvasThumbnail(canvas);
        }
        return '';
    },
